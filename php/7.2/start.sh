...
sudo chown -R westsoftware:westsoftware /home/westsoftware

# copy bash config into place.
cp /home/bashrc /home/westsoftware/.bashrc
...
if [[ $XDEBUG_ENABLED == true ]]; then
    ...
    echo 'xdebug.idekey = "westsoftware"' | sudo tee -a /etc/php7/conf.d/00_xdebug.ini > /dev/null
